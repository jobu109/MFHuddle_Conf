...
export declare class Ch5Image extends Ch5Common implements ICh5ImageAttributes {
    ...
    set allowPositionDataToBeSent(value: boolean);
    get allowPositionDataToBeSent(): boolean;
    set allowValuesOnMove(value: boolean);
    get allowValuesOnMove(): boolean;
    set sendEventXPosition(value: string);
    get sendEventXPosition(): string;
    set sendEventYPosition(value: string);
    get sendEventYPosition(): string;
    set receiveStateAllowValuesOnMove(value: string);
    get receiveStateAllowValuesOnMove(): string;
    set receiveStateAllowPositionDataToBeSent(value: string);
    get receiveStateAllowPositionDataToBeSent(): string;
