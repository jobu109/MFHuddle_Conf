...
export declare class Ch5DateTime extends Ch5Common implements ICh5DateTimeAttributes {
    ...
    set receiveStateDisplay24HourFormat(value: string);
    get receiveStateDisplay24HourFormat(): string;
    set receiveStateDisplayAmPm(value: string);
    get receiveStateDisplayAmPm(): string;
    set receiveStateDisplaySeconds(value: string);
    get receiveStateDisplaySeconds(): string;
    set receiveStateDisplayTwoDigitsHour(value: string);
    get receiveStateDisplayTwoDigitsHour(): string;
    set receiveStateStyleForDate(value: string);
    get receiveStateStyleForDate(): string;
    set receiveStateDisplayType(value: string);
    get receiveStateDisplayType(): string;
